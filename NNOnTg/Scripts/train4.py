...
def main():
    ...
    model: GPT = keras.models.load_model("./models/model_v_alpha_1.8.4.2_pre_train_fine_tuning_256emd_4tr_6h1763832928.455717.keras1763846677.4238.keras")
    model.name_of_model = "model_v_alpha_1.8.4.2.2__30.11.25_pre_train_fine_tuning_v2_256emd_4tr_6h"
